...
public sealed class MembersByFullNameApi
{
    private readonly HttpClient _httpClient;
    private readonly IConfiguration _configuration;

    public MembersByFullNameApi(HttpClient httpClient, IConfiguration configuration)
    {
        _httpClient = httpClient;
        _configuration = configuration;
    }

    public async Task<ResultWrapper<string>> SearchMemberAsync(string fullName, CancellationToken cancellationToken = default)
    {
        try
        {
